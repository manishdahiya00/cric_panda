module Admin
  class AppBannersController < AdminController
  layout  "admin"
  ...
  def create
    @app_banner = AppBanner.new(app_banner_params)
      ...
      if @app_banner.save
         redirect_to admin_app_banner_url(@app_banner), notice: "App banner was successfully created."
      else
  ...
  def update
      if @app_banner.update(app_banner_params)
        redirect_to admin_app_banner_url(@app_banner), notice: "App banner was successfully updated."
      else
  ...
  def destroy
    ...
    redirect_to admin_app_banners_url, notice: "App banner was successfully destroyed."
  end
