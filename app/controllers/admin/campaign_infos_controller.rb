module Admin
  ...
  def create
   ...
   redirect_to admin_campaign_info_url(@campaign_info), notice: "Campaign info was successfully created."
      else
  ...
  def update
      ...
      redirect_to admin_campaign_info_url(@campaign_info), notice: "Campaign info was successfully updated."
      else
render :edit, status: :unprocessable_entity
  ...
  def destroy
    @campaign_info.destroy!
      format.html { redirect_to admin_campaign_infos_url, notice: "Campaign info was successfully destroyed." }
  end
